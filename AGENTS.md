...
- **OpenCode SDK**: ALL integrations must be compliant with **OpenCode SDK v2**. Use the local `opencode-sdk/` directory as the absolute source of truth for types and API structures.
